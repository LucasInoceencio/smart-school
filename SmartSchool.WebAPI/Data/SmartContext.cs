    ...
    public class SmartContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            builder.Entity<AlunoDisciplina>()
                .HasKey(Add => new {Add.AlunoId, Add.DisciplinaId});

                builder.Entity<AlunoCurso>()
                .HasKey(Add => new {Add.AlunoId, Add.CursoId});
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", new DateTime(2005, 5, 28, 0, 0, 0, 0, DateTimeKind.Local)),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", new DateTime(2005, 5, 28, 0, 0, 0, 0, DateTimeKind.Local)),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", new DateTime(2005, 5, 28, 0, 0, 0, 0, DateTimeKind.Local)),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", new DateTime(2005, 5, 28, 0, 0, 0, 0, DateTimeKind.Local)),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", new DateTime(2005, 5, 28, 0, 0, 0, 0, DateTimeKind.Local)),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", new DateTime(2005, 5, 28, 0, 0, 0, 0, DateTimeKind.Local)),
                    new Aluno(7, 7, "Paulo", "José", "9874512", new DateTime(2005, 5, 28, 0, 0, 0, 0, DateTimeKind.Local))
                });
